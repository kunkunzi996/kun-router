...
- 大规模重写 README
- 合并多个 docs 文件
- 删除 AGENTS.md / CLAUDE.md 中的规则

除非用户明确要求，或内容明显错误/重复/空白，否则只标记为“建议合并 / 建议删除”。

## 执行步骤

### Step 1：确认本轮已验收

先确认 `11-verification-git-report.md` 已完成：
